...
import messaging from "../assets/img/conversation.png";
import bgCircles from "../assets/img/circleBg.svg";

const MessagingSection = () => {
  return (
    <MessageStyle id="support">
      <InnerLayout>
        <div className="message-con">
          <div className="left-items">
            ...
            <p className="left-para">
              Notre équipe de support est disponible dans cinq langues
              différentes pour vous aider avec tous les problèmes ou questions
              que vous pourriez avoir. Nous nous efforçons de fournir une
              assistance rapide et efficace pour garantir votre satisfaction
            </p>
