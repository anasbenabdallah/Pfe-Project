...
import wyplay from "../assets/img/wyplay.png";
    ...
    <HeaderContentStyled>
      <div className="left-content">
        <div className="left-text-container">
          <h1 data-aos="zoom-in-right">WyplayFeed </h1>
          <p className="white">
            WyplayFeed s inscrit comme une plateforme innovante, répondant aux
            besoins évolutifs des consommateurs de médias tout en offrant des
            solutions sur mesure pour les opérateurs et diffuseurs.
          </p>
          <SecondaryButton name="Registered now" />
        </div>
      </div>
      <div className="right-content">
        <img src={wyplay} alt="" className="phone" />
